...
/*
 * 两个线程同一时刻访问同一个实例对象的两个不同的普通同步方法的情况
 */

public class SynchronizedDifferentMethods implements Runnable {
    static SynchronizedDifferentMethods instance = new SynchronizedDifferentMethods();
